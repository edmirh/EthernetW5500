...
.LVL0:
	...
	.loc 1 17 10 is_stmt 0 view .LVU20
	ldr	r3, .L7+16
	.loc 1 15 10 view .LVU21
	ldr	r2, .L7+20
	str	r2, [sp, #12]
	.loc 1 16 2 is_stmt 1 view .LVU22
	.loc 1 17 10 is_stmt 0 view .LVU23
	ldm	r3, {r0, r1}
	str	r0, [sp, #28]
	strh	r1, [sp, #32]	@ movhi
	...
	ldr	r3, [r5]
	strh	r3, [r4]	@ movhi
	.loc 1 31 2 view .LVU25
	add	r2, sp, #28
	add	r3, sp, #20
	add	r1, sp, #16
	.loc 1 22 10 view .LVU26
	ldr	r5, .L7+24
	str	r5, [sp, #24]
	...
	strd	r4, r6, [sp, #16]
	.loc 1 21 2 is_stmt 1 view .LVU30
.LVL1:
	.loc 1 22 2 view .LVU31
	.loc 1 23 2 view .LVU32
...
.LVL3:
	...
	bl	writeReg
.LVL4:
	.loc 1 33 22 view .LVU40
	.loc 1 35 2 view .LVU41
...
.LVL5:
	...
	.loc 1 36 11 is_stmt 0 view .LVU43
	movw	r2, #5000
	add	r1, sp, #24
	movs	r0, #1
	bl	connect
.LVL6:
	.loc 1 37 2 is_stmt 1 view .LVU44
	.loc 1 37 4 is_stmt 0 view .LVU45
	cmp	r0, #1
	beq	.L6
	.loc 1 42 3 is_stmt 1 view .LVU46
	ldr	r0, .L7+32
.LVL7:
	.loc 1 42 3 is_stmt 0 view .LVU47
	bl	printUSART2
.LVL8:
.L3:
	.loc 1 44 1 view .LVU48
	movs	r0, #0
	add	sp, sp, #56
	.cfi_remember_state
	.cfi_def_cfa_offset 16
...
.L6:
	.cfi_restore_state
	.loc 1 44 1 view .LVU49
	mov	r4, r0
	.loc 1 38 3 is_stmt 1 view .LVU50
	ldr	r0, .L7+36
.LVL10:
	.loc 1 38 3 is_stmt 0 view .LVU51
	bl	printUSART2
.LVL11:
	.loc 1 39 3 is_stmt 1 view .LVU52
	add	r1, sp, #36
	mov	r0, r4
	movs	r2, #18
	bl	send
